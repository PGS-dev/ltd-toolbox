[@ltd-toolbox/figma-parser - v0.1.0-alpha.6](../README.md) / [Modules](../modules.md) / [dev](../modules/dev.md) / FigmaLocalVariable
...
• **new FigmaLocalVariable**(`raw`, `collection`): [`FigmaLocalVariable`](dev.FigmaLocalVariable.md)
