...
import type { BooleanOperation, Canvas, Component, ComponentSet, Document, Ellipse, Frame, Group, Instance, Line, Node, Rectangle, RegularPolygon, Slice, Star, Text, Vector } from '../../types';
