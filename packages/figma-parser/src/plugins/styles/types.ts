...
export const isTextStyle = (node: FullStyle): node is TextStyle =>
  node.styleMeta.style_type === "TEXT";

export const isEffectStyle = (node: FullStyle): node is EffectStyle =>
  node.styleMeta.style_type === "EFFECT";

export const isShadowEffect = (effect: Effect): effect is Effect =>
  effect.type === "DROP_SHADOW" || effect.type === "INNER_SHADOW";

export const isBlurEffect = (effect: Effect): effect is Effect =>
  effect.type === "LAYER_BLUR" || effect.type === "BACKGROUND_BLUR";

export const isFillDefinition = (
  definition: FigmaStyleDfeinition,
): definition is FigmaStyleDfeinition & { definition: Paint[] } =>
  definition.type === "FILL";

export const isTextDefinition = (
  definition: FigmaStyleDfeinition,
): definition is FigmaStyleDfeinition & { definition: TypeStyle } =>
  definition.type === "TEXT";

export const isEffectDefinition = (
  definition: FigmaStyleDfeinition,
